...
* Studio Solutions: In-class practice that is reviewed but **NOT graded**.
* Graded Assignment Solutions: In-class work that is **graded**.
* Self-Assessments: In-class tool desgined to show students what they know and what they should review. **NOT graded**.
...
2. Enter grade in Canvas
   ...
   * More about feedback in the [feedback section](https://github.com/LaunchCodeEducation/csharp-web-development/wiki/Grading-and-Student-Progress#feedback)
...
GitHub classroom provides an overview of graded assignments submitted by the student.
